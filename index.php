    ...
    <section class="hero-section">
        ...
        <div class="container hero-grid">
            <div class="hero-content">
                ...
                <p class="hero-subtitle">Saya adalah mahasiswa Informatika yang berfokus pada pengembangan website, front-end development, PHP, dan database.</p>
                <p>Saya tertarik membangun website yang rapi, responsif, mudah digunakan, dan memiliki struktur data yang jelas. Saat ini saya terus mengembangkan kemampuan melalui project kuliah, latihan mandiri, dan pengembangan portfolio digital.</p>
                <div class="hero-actions">
                    ...
                    <a class="btn btn-ghost" href="<?= h(asset_url('uploads/cv-placeholder.pdf')); ?>" download>Unduh CV</a>
                </div>
            </div>
            <div class="hero-visual">
                <div class="hero-panel">
                    ...
                    <div class="hero-photo-wrap">
                        <img class="hero-photo" src="https://cdn.phototourl.com/free/2026-06-20-5bcd3876-7217-4482-9f97-a8e21bdccce8.png" alt="Foto <?= h($profile['nama']); ?>">
                    </div>
